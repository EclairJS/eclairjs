...
(function () {
     ...
     */
    var DoubleParam = function (parent,  name,  doc) {
        var jvmObject;
        if (arguments[0] instanceof org.apache.spark.ml.param.DoubleParam) {
            jvmObject = arguments[0];
        } else {
            jvmObject = new org.apache.spark.ml.param.DoubleParam(parent,  name,  doc);
        }

        this.logger = Logger.getLogger("DoubleParam_js");
