...
(function () {
     ...
     */
    var IntParam = function (parent,  name,  doc) {
        var jvmObject;
        if (arguments[0] instanceof org.apache.spark.ml.param.IntParam) {
            jvmObject = arguments[0];
        } else {
            jvmObject = new org.apache.spark.ml.param.IntParam(parent,  name,  doc);
        }

        this.logger = Logger.getLogger("IntParam_js");
