...
MLWord2Vec.prototype.setWindowSize = function (value) {
    return  new MLWord2Vec(this.getJavaObject().setWindowSize(value));
}
...
MLWord2Vec.prototype.setStepSize = function (value) {
    return new MLWord2Vec(this.getJavaObject().setStepSize(value));
}
...
MLWord2Vec.prototype.setNumPartitions = function (value) {
    return  new MLWord2Vec(this.getJavaObject().setNumPartitions(value));
}
...
MLWord2Vec.prototype.setMaxIter = function (value) {
    return  new MLWord2Vec(this.getJavaObject().setMaxIter(value));
}
...
MLWord2Vec.prototype.setSeed = function (value) {
    return  new MLWord2Vec(this.getJavaObject().setSeed(value));
}
...
MLWord2Vec.prototype.transformSchema = function (schema) {
    ...
    return  new StructType(this.getJavaObject().transformSchema(schema_uw));
}
