...
(function () {
    ...
    var logger = Logger.getLogger("sql.SparkSession_js");

    var SparkSessionBuilder = require(EclairJS_Globals.NAMESPACE + '/sql/SparkSessionBuilder');
    ...
    var SparkSession = function(jvmObject) {
    	 
    	 this.logger = Logger.getLogger("SparkSession_js");
    	 JavaWrapper.call(this, jvmObject);
    
    };
    
    SparkSession.prototype = Object.create(JavaWrapper.prototype);
    
    SparkSession.prototype.constructor = SparkSession;
    ...
    SparkSession.prototype.version = function() {
       return  this.getJavaObject().version();
    };
     ...
     * @returns {module:eclairjs/sql.Dataset} 
     */
    SparkSession.prototype.range0 = function(end) {
    throw "not implemented by ElairJS";
    //   var javaObject =  this.getJavaObject().range(end);
    //   return new Dataset(javaObject);
    };
     ...
     * @returns {module:eclairjs/sql.Dataset} 
     */
    SparkSession.prototype.range1 = function(start,end) {
    throw "not implemented by ElairJS";
    //   var javaObject =  this.getJavaObject().range(start,end);
    //   return new Dataset(javaObject);
    };
     ...
     * @returns {module:eclairjs/sql.Dataset} 
     */
    SparkSession.prototype.range2 = function(start,end,step) {
    throw "not implemented by ElairJS";
    //   var javaObject =  this.getJavaObject().range(start,end,step);
    //   return new Dataset(javaObject);
    };
...
//       return Utils.javaToJs(javaObject);
    ...
    SparkSession.builder = function() {
       var javaObject =  org.apache.spark.sql.SparkSession.builder();
    ...
    SparkSession.setActiveSession = function(session) {
       var session_uw = Utils.unwrapObject(session);
