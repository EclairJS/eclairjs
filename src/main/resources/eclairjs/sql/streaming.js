(function () {
     ...
     * @example
     * var streaming = require('eclairjs/sql/streaming');
     * @module eclairjs/sql/streaming
     */
    module.exports = {
      // StreamingQueryManager: require(EclairJS_Globals.NAMESPACE + '/sql/streaming/StreamingQueryManager'),
       // StreamingQueryException: require(EclairJS_Globals.NAMESPACE + '/sql/streaming/StreamingQueryException'),
       // StreamingQueryListener: require(EclairJS_Globals.NAMESPACE + '/sql/streaming/StreamingQueryListener'),
       // SinkStatus: require(EclairJS_Globals.NAMESPACE + '/sql/streaming/SinkStatus'),
