 ...
 */
{
    var BooleanType = require('sql/types/BooleanType');
    var DateType = require('sql/types/DateType');
    var DoubleType = require('sql/types/DoubleType');
    var FloatType = require('sql/types/FloatType');
    var IntegerType = require('sql/types/IntegerType');
    var StringType = require('sql/types/StringType');
    var TimestampType = require('sql/types/TimestampType');
    var NullType = require('sql/types/NullType');
    var BinaryType = require('sql/types/BinaryType');
    var CalendarIntervalType = require('sql/types/CalendarIntervalType');
