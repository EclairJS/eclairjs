...
public class JavaMultilayerPerceptronClassifierExample {
    ...
    public static void main(String[] args) {
        SparkConf conf = new SparkConf().setAppName("JavaMultilayerPerceptronClassifierExample").setMaster("local[*]");
        JavaSparkContext jsc = new JavaSparkContext(conf);
        SQLContext jsql = new SQLContext(jsc);

        // $example on$
        // Load training data
        String path = "examples/data/mllib/sample_multiclass_classification_data.txt";
        ...
        MultilayerPerceptronClassifier trainer = new MultilayerPerceptronClassifier()
               ...
               // .setBlockSize(128)
                ...
                //.setMaxIter(100);
        // train the model
        MultilayerPerceptronClassificationModel model = trainer.fit(dataFrame /*train*/);
