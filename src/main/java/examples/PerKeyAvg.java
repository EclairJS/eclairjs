...
public final class PerKeyAvg {
    ...
    public static void main(String[] args) throws Exception {
        ...
        input.add(new Tuple2("coffee", 4));
        input.add(new Tuple2("pandas", 3));

        //JavaRDD<String, Integer> jrdd = sc.parallelize(input);
        //JavaPairRDD<String, Integer> rdd = sc.parallelizePairs(input);
        JavaPairRDD rdd = sc.parallelizePairs(input);
        Function<Integer, AvgCount> createAcc = new Function<Integer, AvgCount>() {
            @Override
            public AvgCount call(Integer x) {
                System.err.println("createAcc: " + x);
        ...
        Function2<AvgCount, Integer, AvgCount> addAndCount = new Function2<AvgCount, Integer, AvgCount>() {
            ...
            public AvgCount call(AvgCount a, Integer x) {
                System.err.println("addAndCount a=" +  a.total_ + " a.n= "+ a.num_ + " x= " + x);
                a.total_ += x;
                a.num_ += 1;
                return a;
            }
