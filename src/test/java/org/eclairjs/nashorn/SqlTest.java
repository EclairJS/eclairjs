...
public class SqlTest {
    ...
    public void dataFrameDtypesTest() throws Exception {
        ...
        String json = "[\"(name,StringType)\",\"(age,IntegerType)\",\"(expense,IntegerType)\",\"(DOB,TimestampType)\",\"(income,DoubleType)\",\"(married,BooleanType)\",\"(networth,DoubleType)\"]";
        assertEquals("should be same", json, ret);
    }
    ...
    public void dataFrameJoin() throws Exception {
        ...
        assertEquals("should be same", "[Michael,29,1,1996-03-07 00:00:00.0,1200.4,true,300000000.11,Michael,29,1,1996-03-07 00:00:00.0,1200.4,true,300000000.11]", ret);
    }
