...
public class SqlStreamingTest {
    ...
    public void sinkSourceStatusTest() throws Exception {
        ...
        String expected = "{\"sink\":{\"description\":\"org.apache.spark.sql.execution.streaming.ForeachSink\",\"offsetDesc\":\"[\"},\"source\":{\"description\":\"FileStreamSource[file:/Users/billreed/eclairjs_dev/e\",\"offsetDesc\":\"S\"}}";
        assertEquals("should be same", expected, ret.toString());
    }
